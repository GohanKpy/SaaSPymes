...
/**
 * Construye la app completa (cookies, CORS, prefijo, filtros) SIN escuchar
 * en ningun puerto: main.ts la levanta de verdad y el e2e de aislamiento la
 * ejercita por inject() con la misma configuracion que produccion.
 */
